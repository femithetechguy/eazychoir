...
export default class ScheduleSection {
  ...
  render() {
    ...
    this.loadData().then((data) => {
        ...
        <div class="mobile-menu-overlay">
          <div class="mobile-menu-panel">
            ...
            <nav class="mobile-nav-links">
              ...
              <a href="#schedule-section" class="nav-link active">Schedule</a>
      ...
      `;
      container.appendChild(mobileNavMenu);

      // Add mobile menu toggle functionality
      setTimeout(() => {
        const menuToggle = container.querySelector(".mobile-menu-toggle");
        const menuClose = container.querySelector(".mobile-menu-close");
